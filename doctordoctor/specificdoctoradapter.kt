...
class specificdoctoradapter(context: Context, specificdoctorArrayList: ArrayList<specificdoctorsavailable?>) :
    ArrayAdapter<specificdoctorsavailable?>(context, 0, specificdoctorArrayList) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val doctorModel: specificdoctorsavailable? = getItem(position)
